...
stage_dir="/tmp/airo_wrm_wrap_stratified_cluster6_stage"
...
work_root="/tmp/airo_wrm_wrap_stratified_cluster6_work"
repo_root="${work_root}/AIRO-Doffy"
dataset_root="${work_root}/datasets/WRM_grasp_cylinder_different_sizes_lero_tightness"
output_root="/project_ghent/AIRO-Doffy/WRM_grasp_cylinder_different_sizes_lero_tightness/wrm_wrap_stratified_cluster6_bs32"
...
if [[ -f "${policy_output}/last.pt" ]]; then
    ...
    "${python_bin}" -m policies.realman_beaver.train \
        ...
        --wandb-run-name "WRM_grasp_cylinder_different_sizes_lero_tightness/WRM_wrap-stratified-cluster6-bs32" \
...
echo "[$(date -Is)] completed Cluster6 batch-size-32 WRM_wrap stratified training"
